...
2. Для каждого ингредиента определи "search_term" — краткое название продукта для поиска в базе нутриентов (нормализуй: единственное число, без бытового сленга). Можно указывать на русском, если продукт стандартный.
